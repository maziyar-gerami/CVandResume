...
\hspace{20 pt} January 2024 - Peresent}{}
{
  ...
  {Microservice, Kubernetes, Scrum, Linux, Clean Code, Clean Architecture, BDD, JUnit, Mockito, Elastic Search, Logstash, Figma} 
 \emptySeparator
...
\end{itemize}
}{Central Authentication System, Single Sign in Single Sign out (SSO), Tomcat, Gradle, Hibernate, Redis, REST API, Bash Script, Linux, Scrum}
\emptySeparator
\experience
  {}
  {Android Developer}
